#' BayesianLossFunctionBinomial
#'
#' BayesianLossFunctionBinomial
#'
#' @title BayesianLossFunctionBinomial: BayesianLossFunctionBinomial
#' @param mu numeric
...
#' @examples
#'
#' @rdname BayesianLossFunctionBinomial
#' @export BayesianLossFunctionBinomial


setGeneric("BayesianLossFunctionBinomial",
           function(type = c("OPC", "RTC"), ...){
             standardGeneric("BayesianLossFunctionBinomial")
           })

setMethod("BayesianLossFunctionBinomial",
