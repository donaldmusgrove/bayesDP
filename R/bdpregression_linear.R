...
#'
#' @title print: print
#' @param x post_est_gaussian
#'
#' @examples
#'
#' @rdname print
#' @export print
setMethod("print", signature(x = "post_est_gaussian"), function(x){
...
#' @rdname plot
#' @export plot
setMethod("plot", signature(x = "post_est_gaussian"), function(x){
