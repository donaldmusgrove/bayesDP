...
setGeneric("Discount_function",
           function(mu          = NULL,
                    ...
                    weibull_shape = 3,
                    two_side      = 1){
             standardGeneric("Discount_function")
           })

setMethod("Discount_function",
          signature(),
          function(mu          = NULL,
                   sigma       = NULL,
                   N           = NULL,
...
setGeneric("mu_post_aug",
           function(mu          = NULL,
                    ...
                    alpha_discount = NULL,
                    number_mcmc = 10000){
             standardGeneric("mu_post_aug")
           })

setMethod("mu_post_aug",
          signature(),
          function(mu          = NULL,
                   sigma       = NULL,
                   N           = NULL,
  ...
  setGeneric("mu_posterior",
             function(mu          = NULL,
                      ...
                      weibull_shape = 3,
                      two_side      = 1){
               standardGeneric("mu_posterior")
             })

  setMethod("mu_posterior",
            signature(),
            function(mu          = NULL,
                     sigma       = NULL,
                     N           = NULL,
