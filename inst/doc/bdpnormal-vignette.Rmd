...
The CI is computed at run time and is the interval estimate of the difference between the posterior means of the treatment and control groups. With a 95% CI of `(3.6263, 6.3496)`, we would conclude that the treatment and control arms are not significantly different.
