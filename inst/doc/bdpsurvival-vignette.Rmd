...
Now, suppose we desire a two-arm analysis. Then, the current and historical data frames must contain a column named exactly `treatment`. The treatment column is binary and indicates treatment and control observations. Now, the formula input `Surv(time, status) ~ treatment` specifies a two-arm treatment. 
