...
test_that("Normal", {
  expect_true(class(try(bdpnormal(9,9,9,9,9,9), silent = TRUE)) != "try-error",
...
test_that("Normal Plot", {
  expect_true(class(try(plot(bdpnormal(9,9,9,9,9,9)), silent = TRUE)) != "try-error",
               "1arm Normal Test Plot Error")
  expect_true(class(try(plot(bdpnormal(9,9,9,9,9,9,9,9,9,9,9,9)), silent = TRUE)) != "try-error",
...
test_that("Normal Print", {
  expect_true(class(try(print(bdpnormal(9,9,9,9,9,9)), silent = TRUE)) != "try-error",
               "1arm Normal Test Print Error")
  expect_true(class(try(print(bdpnormal(9,9,9,9,9,9,9,9,9,9,9,9)), silent = TRUE)) != "try-error",
...
test_that("Normal Summary", {
  expect_true(class(try(summary(bdpnormal(9,9,9,9,9,9)), silent = TRUE)) != "try-error",
              "1arm Normal Test Summary Error")
  expect_true(class(try(summary(bdpnormal(9,9,9,9,9,9,9,9,9,9,9,9)), silent = TRUE)) != "try-error",
